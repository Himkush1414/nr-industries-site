// Vendored from React Bits (@react-bits/ScrollExpand-TS-TW), used as-is.
//
// `npx shadcn@latest add @react-bits/ScrollExpand-TS-TW` requires an
// interactive `shadcn init` (framework/preset/base selection) that can't run
// in a non-interactive shell, and would scaffold a components.json + base UI
// preset well beyond this one component. So this file is hand-vendored
// instead, matching how AccordionGallery.tsx was already brought into this
// project. No logic, styling, animation, or behaviour is modified from the
// registry source.
