// Vendored from React Bits (@react-bits/AccordionGallery-TS-TW), used as-is.
//
// The ONLY change from the upstream source: the first `react` import is split so
// the type-only names (CSSProperties, KeyboardEvent, MouseEvent) go through
// `import type`, which this repo's `verbatimModuleSyntax: true` tsconfig
// requires. No logic, styling, animation, or behaviour is modified.
